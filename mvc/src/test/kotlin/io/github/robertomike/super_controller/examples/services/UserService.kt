...
@Service
open class UserService(override val repository: UserRepository, override val mapper: UserRequestMapper) : SuperService<User, Long, StoreUserRequest, StoreUserRequest>() {
