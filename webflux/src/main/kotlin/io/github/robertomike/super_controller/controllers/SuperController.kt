...
//            .flatMap {
//                executePolicy(SHOW, it)
//                    .policyIsValid()
//                    .thenReturn(it)
//            }
////            .then(service.show(it))
//            .map { model -> transform(model) }
//    }
//
//    override fun update(@PathVariable id: ID, @Valid @RequestBody monoRequest: Mono<UR>): Mono<Any> {
//        return Mono.zip(service.findById(id), monoRequest)
//            .flatMap {
//                executePolicy(UPDATE, it.t1, it.t2).policyIsValid()
//                    .thenReturn(it)
//            }.flatMap { service.update(it.t1, it.t2) }
//            .map { model -> transform(model) }
//    }
//
//    override fun destroy(@PathVariable id: ID): Mono<Unit> {
//        return service.findById(id).flatMap {
//            executePolicy(DESTROY, it).policyIsValid()
//        }.flatMap {
//            service.delete(it)
//        }
//    }
